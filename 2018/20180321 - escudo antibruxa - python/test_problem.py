...
class TestProblem(unittest.TestCase):
    ...
    def test_kids_win_x_criancas_escape(self):
        criancas = [(0, 0), (2, 0)]
        sal = 12
        self.assertEqual(
            escudo_antibruxa(criancas, sal),
    ...
    def test_kids_wins_x_criancas_escape(self):
        criancas = [(0, 0), (2, 0)]
        sal = 13
        self.assertEqual(
            escudo_antibruxa(criancas, sal),
    ...
    def test_bruxa_wins_x_far(self):
        criancas = [(0, 0), (3, 0)]
        sal = 12
        self.assertEqual(
            escudo_antibruxa(criancas, sal),
    ...
    def test_kids_win_x_farer(self):
        criancas = [(0, 0), (4, 0)]
        sal = 16
        self.assertEqual(
            escudo_antibruxa(criancas, sal),
