...
class TestProblem(unittest.TestCase):
    ...
    def test_11(self):
        self.assertEqual(letter_range('abc'), ['a:c'])

    def test_12(self):
        self.assertEqual(letter_range('bcd'), ['b:d'])

    def test_13(self):
        self.assertEqual(letter_range('abd'), ['a:b', 'd:d'])

    def test_14(self):
        self.assertEqual(letter_range('dca'), ['a:a', 'c:d'])
