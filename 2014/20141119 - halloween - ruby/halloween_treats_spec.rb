...
describe 'Halloween Treats' do
  ...
  it 'duas criancas, duas casas, cinco doces' do
    doces = [2, 3]

    expect(halloween(2, doces)).to eq([1, 2])
  end

  it 'duas criancas, tres casas, cinco doces' do
    doces = [2, 2, 1]

    expect(halloween(2, doces)).to eq([1, 2])
  end

  it 'duas criancas, tres casas, tres doces' do
    doces = [1, 1, 1]

    expect(halloween(2, doces)).to eq([1, 2])
  end

  it 'duas criancas, cinco casas, cinco doces' do
    doces = [1, 1, 1, 1, 1]

    expect(halloween(2, doces)).to eq([1, 2, 3, 4])
  end

  it 'duas criancas, cinco casas, sete doces' do
    doces = [1, 1, 1, 1, 3]

    expect(halloween(2, doces)).to eq([1, 2, 3, 5])
  end
end